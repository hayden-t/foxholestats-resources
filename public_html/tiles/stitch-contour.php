...
$imagePath = $path.'/tiles/stitched/worldmap-contour.png';
...
foreach($localIndex as $tileName => $tileData){
	if($tileData['id'] < 20)continue;
		...
		$mapPath = $path.'/tiles/masked/'.str_replace('Hex','',$tileName).'_HeightMap.png';
...
echo "<img style='width:1000px;' src='/tiles/stitched/worldmap-contour.png' />";

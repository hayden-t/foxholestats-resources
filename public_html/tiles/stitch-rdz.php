...
$imagePath = $path.'/tiles/stitched/worldmap_rdz.png';
...
foreach($localIndex as $tileName => $tileData){
	if($tileData['id'] < 20 || $tileData['id'] == 34 || $tileData['id'] == 26)continue;
	

		$mapPath = $path.'/tiles/rdz/Map'.$tileName.'.png';
...
echo "<img style='width:1000px;' src='/tiles/stitched/worldmap_rdz.png' />";
